...
const slides = [
  {
    ...
    text: "Indique ton objectif et ton niveau pour adapter automatiquement tes macros.",
    image: require("../assets/images/onboarding-profil.png"),
  },
  {
    id: "2",
    title: "Scanne ton repas",
    text: "Prends une photo de ton assiette et visualise lՎquilibre de tes macros.",
          ...
          {slides.map((_, index) => (
            <View
              ...
              style={{
                ...
                marginHorizontal: 4,
                backgroundColor:
                  currentIndex === index ? "#22c55e" : "rgba(255,255,255,0.22)",
              }}
            />
          ))}
        </View>
