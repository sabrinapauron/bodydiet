  ...
  if (!permission.granted) {
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: "#0b1220", justifyContent: "center", alignItems: "center", padding: 24 }}>
        ...
        >
          <Text style={{ color: "#04130a", fontWeight: "900" }}>Autoriser la caméra</Text>
        </TouchableOpacity>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0b1220" }}>
      <ScrollView contentContainerStyle={{ padding: 16, paddingTop: 18, paddingBottom: 40 }}>
          ...
          >
            ...
            {countdown !== null && (
              ...
              >
                ...
                >
                  <Text style={{ color: "#22c55e", fontSize: 44, fontWeight: "900" }}>
                    {countdown}
                  </Text>
                </View>
              </View>
        ...
        <View style={{ flexDirection: "row", gap: 10, marginTop: 18 }}>
          ...
          >
            <Text style={{ color: "#04130a", fontWeight: "900", fontSize: 16 }}>
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            borderRadius: 14,
            backgroundColor:
              step === "done" ? "rgba(34,197,94,0.18)" : "rgba(148,163,184,0.10)",
            borderWidth: 1,
            borderColor:
              step === "done" ? "rgba(34,197,94,0.35)" : "rgba(255,255,255,0.08)",
            alignItems: "center",
          }}
        >
          <Text
            style={{
              color: step === "done" ? "#22c55e" : "#94a3b8",
              fontWeight: "900",
            }}
          >
